...
<style>
    ...
    [data-testid="stSidebar"] {
        ...
        border-right: 1px solid #1A2F50 !important;
    }
    ...
    .stSlider > div > div > div > div > div {
        ...
        border: 3px solid #070D1A !important;
        width: 20px !important;
        height: 20px !important;
        border-radius: 50% !important;
        box-shadow: 0 0 10px rgba(20,184,166,0.5), 0 0 20px rgba(20,184,166,0.2) !important;
    ...
    .stSlider > div > div > div > div > div:hover {
        box-shadow: 0 0 16px rgba(20,184,166,0.8), 0 0 32px rgba(20,184,166,0.4) !important;
    }
    ...
    .stProgress > div > div > div > div {
        background: linear-gradient(90deg, #0D9488, #14B8A6, #0891B2) !important;
        border-radius: 10px !important;
    }
    ...
    .main-header::before {
        ...
        height: 3px;
        background: linear-gradient(90deg, #0D9488, #0891B2, #8B5CF6);
    }
    ...
    .severity-high {
        background: linear-gradient(135deg, #2D1A00, #3D2400);
        padding: 1.2rem 1.8rem;
        border-radius: 14px;
        color: #FCD34D;
        font-weight: 600;
    ...
    .severity-medium {
        background: linear-gradient(135deg, #0A1F2D, #0D2A3D);
        padding: 1.2rem 1.8rem;
        border-radius: 14px;
        color: #7DD3FC;
        font-weight: 600;
    ...
    .severity-low {
        background: linear-gradient(135deg, #052015, #073520);
        padding: 1.2rem 1.8rem;
        border-radius: 14px;
        color: #6EE7B7;
        font-weight: 600;
...
<div class="main-header">
    <h1>
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" style="vertical-align:-6px; margin-right:10px;">
            <path d="M22 12h-4l-3 9L9 3l-3 9H2" stroke="#0D9488" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        MedGraph AI
    </h1>
    <p>Symptom-Based Disease &amp; Treatment Assistant &nbsp;·&nbsp; ChromaDB &nbsp;·&nbsp; RAG &nbsp;·&nbsp; Neo4j Knowledge Graph</p>
</div>
""", unsafe_allow_html=True)
...
# -----------------------------
# ★ NEW FEATURE 1: PLOTLY CONFIDENCE CHART
# -----------------------------
